...
constexpr auto tuple_awaitable = net::as_tuple(net::use_awaitable);
...
int main_impl(int argc, char** argv) {
  ...
  net::co_spawn(
    ...
    // зачем это здесь? можем ли мы это опустить чтобы эксепшоны дальше по стеку шли?
